...
{for(var i = 0, len = gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.SetHalfPeriodTimeContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.SetHalfPeriodTimeContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setHalfPeriodTime((Number(eventsFunctionContext.getArgument("Value")) || 0));
}
}
}
